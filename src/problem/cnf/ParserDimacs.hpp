...
private:
  /**
    Parse a DIMACS stream into clause vectors and metadata vectors and return
    the number of variables.

    @param[in] in the stream buffer where we get the information, should be data
    from a DIMACS file.
  ...
  */
  ...
  /**
    ...
    @param[in] in the stream buffer where we get the information, should be
    Buffer of a DIMACS file.
    @param[out] problemManager the CNF problem manager where we store the parsed
    information.
    @return the number of variables in the CNF formula.
   */
...
public:
  ...
  */
   ...
   * @param problemManager the CNF problem manager where we store the parsed
   * information.
   * @return the number of variables in the CNF formula.
   */

...
#include "src/caching/cnf/BucketManagerAll.hpp"
#include "src/exceptions/BucketException.hpp"
#include "src/problem/ProblemTypes.hpp"
#include "src/utils/Enum.hpp"

namespace d4 {
template <class T> class BucketManagerAll;

template <class T> class BucketManagerAllCl : public BucketManagerAll<T> {
private:
  /**
...
public:
  /**
     ...
     pages.
  */
  BucketManagerAllCl(SpecManagerAll &occM, CacheManager<T> *cache,
                     ModeStore mdStore, unsigned long sizeFirstPage,
                     unsigned long sizeAdditionalPage,
                     BucketAllocator *bucketAllocator = new BucketAllocator())
      : BucketManagerAll<T>::BucketManagerAll(occM, cache, mdStore,

...
ConfigConverter::fromVariablesMap(boost::program_options::variables_map &vm) {
  ...
  config.maxsharpsat_heuristic_phase =
      vm["maxsharpsat-heuristic-phase"].as<string>();
  config.maxsharpsat_heuristic_phase_random =
      vm["maxsharpsat-heuristic-phase-random"].as<unsigned>();
  config.maxsharpsat_option_and_dig =
      vm["maxsharpsat-option-and-dig"].as<bool>();
  config.maxsharpsat_option_greedy_init =
  ...
  config.partitioning_heuristic_bipartite_phase =
      vm["partitioning-heuristic-bipartite-phase"].as<string>();
  config.partitioning_heuristic_bipartite_phase_dynamic =
      vm["partitioning-heuristic-bipartite-phase-dynamic"].as<double>();
  config.partitioning_heuristic_bipartite_phase_static =
  ...
  config.cache_clause_representation =
      vm["cache-clause-representation"].as<string>();
  ...
  config.cache_limit_number_variable =
      vm["cache-limit-number-variable"].as<unsigned>();
  ...
  config.keyword_output_format_solution =
      vm["keyword-output-format-solution"].as<string>();
